...
func init() {
	Register("continue", continueTemplate)
}

const continueTemplate = `Continue the next missing artifact for an existing change. Create exactly ONE artifact, then STOP.
